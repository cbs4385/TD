...
namespace FaeMaze.Editor
{
    ...
    public class HeartPowerDefinitionGenerator
    {
        ...
        public static void GeneratePowerDefinitions()
        {
            ...
            //     assetPath, cooldown: 15f, duration: 10f, radius: 5f);
            ...
            //     assetPath, cooldown: 25f, duration: 5f, radius: 3f, param1: 8f);
            ...
            //     assetPath, cooldown: 30f, duration: 20f, radius: 0f, param1: 0.5f);
            ...
            //     assetPath, cooldown: 15f, duration: 60f, radius: 1f, param1: 2f);
